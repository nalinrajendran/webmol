...
var History = {
    ...
    Sketcher = {
        ...
        init: function() {
            MPFragments.init(), this.initPeriodicTable(), this.resizeToolbars(), $("#action-mp-color-mode").toggleClass("tool-button-selected", Preferences.get("sketcher", "colored", !0)), $("#action-mp-skeletal-formula").toggleClass("tool-button-selected", !Preferences.get("sketcher", "skeletal_formula", !0)), Detector.canvas ? (this.molpad = new MolPad(document.getElementById("molpad-canvas-wrapper"), MolView.devicePixelRatio, {
                undo: "#action-mp-undo",
                redo: "#action-mp-redo"
            }), this.molpad.setSkeletalDisplay(Preferences.get("sketcher", "skeletal_formula", !0)), this.setColored(Preferences.get("sketcher", "colored", !0)), this.setTool($("#action-mp-lasso"), "select", {
                type: "lasso"
            }), MolView.loadDefault && this.loadMOL(defaultMol2D), this.molpad.onChange(function() {
                ...
                for (var o = -1, a = 0; a < e[t].elements.length; a++) {
                    ...
                    if ("" !== s.name) {
                        ...
                        $('<div class="pt-element"></div>').attr("title", s.name).append($("<h3></h3>").html(s.number)).append($("<h4></h4>").html(s.small).css("color", JmolAtomColorsHashHex[s.small])).data("element", s.small).on(MolView.trigger, function() {
                            $("#molpad .primary-tool").removeClass("tool-button-selected"), $("#action-mp-periodictable").addClass("tool-button-selected"), Sketcher.molpad.setTool("atom", {
    ...
    SearchGrid = {
        ...
        addEntry: function(e) {
            if ("pubchem" === this.db) {
                ...
                e.Title && (a = $('<div class="search-result-title"><span>' + ucfirst(humanize(e.Title)) + "</span></div>"), t.append(a), a.textfill({
                    maxFontPoints: 26
                }));
                ...
                t.append(a), a.textfill({
                    maxFontPoints: 26
                });
                var s, i = 500 / MolView.devicePixelRatio,
                ...
                t.append(a), a.textfill({
                    maxFontPoints: 26
                }), $('<div class="search-result-codid">' + e.codid + "</div>").appendTo(t);
            ...
            loadCIDS: function(e) {
                0 !== e.length && Request.PubChem.description(e, function(e) {
                    for (var t = [], o = 0; o < e.InformationList.Information.length; o++) {
                        var a = e.InformationList.Information[o].CID; - 1 === t.indexOf(a) && (t.push(a), SearchGrid.addEntry(e.InformationList.Information[o]))
                    }
    ...
    Actions = {
        ...
        export_spectrum_jcamp: function() {
            var e;
            Spectroscopy.data[$("#spectrum-select").val()] ? null !== (e = new Blob([Spectroscopy.data[$("#spectrum-select").val()]], {
                type: "chemical/x-jcamp-dx;charset=utf-8"
            })) && saveAs(e, $("#spectrum-select").find("option:selected").text() + ".jdx") : alert("No spectrum selected!")
        }
    };
...
var Link = {
        ...
        updateShareDialog: function() {
            ...
            var e = window.location.origin + window.location.pathname,
                t = "";
            "" !== Loader.lastQuery.type && (t = "Cool structure on MolView!", e += "?" + Loader.lastQuery.type + "=" + specialEncodeURIComponent(Loader.lastQuery.content.replace(/^ /, ""))), $("#share-link").val(e), $("#share-dialog .social").share({
                all: e
            }, !1, t)
        },
        ...
        update: function(e) {
            ...
            this.data = {}, InfoCard.update(e), $("#spectrum-nist-source").hide(), $("#spectrum").addClass("loading"), $("#spectrum-select").html('<option value="loading" selected>Loading&hellip;</option>').val("loading"), this.print("No spectrum selected"), InfoCard.getProperty("cas", function(e) {
                Spectroscopy.data.cas = e, Request.NIST.lookup(Spectroscopy.data.cas, function(e) {
                    if ($("#spectrum-select").empty(), $("#spectrum-select").append('<option value="default" disabled selected style="display:none;">Choose a spectrum</option>'), e.mass && $("#spectrum-select").append('<option value="nist-mass">Mass spectrum</option>'), void 0 !== e.ir)
...
var Autocomplete = {
        ...
        focusRecord: function(e) {
            ...
            var t, o = $(".autocomplete-item").eq(e); - 1 !== e && (o.addClass("autocomplete-item-active"), (t = o.position()).top + o.outerHeight() > $("#autocomplete-dropdown").outerHeight() ? $("#autocomplete-dropdown").scrollTop($("#autocomplete-dropdown").scrollTop() - $("#autocomplete-dropdown").outerHeight() + t.top + o.outerHeight()) : t.top < 0 && $("#autocomplete-dropdown").scrollTop($("#autocomplete-dropdown").scrollTop() + t.top))
        },
        keydown: function(e) {
    ...
    MolView = {
        ...
        init: function() {
            ...
            }, function() {}), $(".dropdown-menu a").on(this.trigger, function(e) {
